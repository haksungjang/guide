...
ajswj새로운 오픈소스를 공개하는게 아니라 기존의 외부 오픈소스 프로젝트에 기여하기 위한 사항은 다음 페이지를 참고하세요.
...
소프트웨어를 오픈소스로 공개하기 위해서는 라이선스를 명시해야 합니다. 그래야 다른 사람들이 소프트웨어를 사용, 복사, 수정 및 배포할 수 있습니다. 또한, 당신을 법적인 상황으로부터 보호합니다. 따라서, 오픈소스 프로젝트를 시작할때 적절한 오픈소스 라이선스를 선택하고 이를 프로젝트에 포함시켜야 합니다. 
